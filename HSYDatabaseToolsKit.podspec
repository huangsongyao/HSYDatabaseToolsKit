...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/317398895@qq.com/HSYDatabaseToolsKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '317398895@qq.com' => '317398895@qq.com' }
  s.source           = { :git => 'https://github.com/317398895@qq.com/HSYDatabaseToolsKit.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'HSYDatabaseToolsKit/Classes/**/*'
